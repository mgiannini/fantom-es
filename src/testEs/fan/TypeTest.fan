...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testIdentity()
  {
    ...
    verifyEq(t.toStr, "testEs::TypeTest")
    verifyEq(t.toLocale, "testEs::TypeTest")
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  Void testMake()
  {
    // TODO:FIXIT (need these types implemented in sys)
    verify(Version#.make([[2]]) is Version)
    // verify(File#.make([`foo`]) is File)
    // verifyEq(File#.make([`foo`])->uri, `foo`)

    // This test was always commented out
